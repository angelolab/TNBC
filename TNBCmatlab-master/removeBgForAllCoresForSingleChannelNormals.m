...
%% NOTE: THE NEW NORMALS HAD REALLY BAD BACKGROUND TO WE REMOVE THE SINGLE CHANEL FROM COUNTSNOBG INSTEAD OF COUNTSALLSFILTCRSUM
...
for i=45:48
    ...
    for j=1:length(targetChannels)
        ...
        countsNoBg(:,:,targetChannelInd) = MibiRemoveBackgroundByMaskSingleChannel(countsNoBg(:,:,targetChannelInd),mask,removeVal);
    end
