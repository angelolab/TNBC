...
resultsDir = [path,'dataPerCell170904/ClusterAll170905/'];

phenoS = importdata([pathCluster,'/data_ClusterAll170905.csv']);
% phenoCol = 80;
% tsne1Col = 74;
% tsne2Col = 75;
phenoCol = 56;
...
% cluster
clusterInds = [4,6,7,13,19,20,21,23,26,27,28,29,31,33,36,37];
...
immuneCategories = [21,2,27,5,36,41,44,1,7,22,24,4,9,19,14,16];
...
%     save([path,'/Point',num2str(i),'/cellDataCategory170829.mat'],'dataPoint','Labels2Write');
...
% 
% save([pathCluster,'dataSeparateImmuneTumor170829.mat'],'phenoS');