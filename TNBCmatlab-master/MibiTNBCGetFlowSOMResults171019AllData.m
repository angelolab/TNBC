%MibiTNBCGetFlowSOMResults171019AllData plot heatmap of flowSOM results
points=43;
...
phenoS = importdata([pathCluster,'/allDataBeforeClustering171019.csv']);
phenoCol = 53;
resultsDir = [path,'/dataPerCell171019/ClusterAll171019/'];


% add flowSOM data
flowSOMpath = '/Users/lkeren/Box Sync/Leeat_Share/Data/MIBIData/CleanData/NoAgg/dataPerCell171019/flowsomresultsAll171019.csv';
...
immuneCategories = [21,65,64,63,55,75,54,15,14,4,3,13,5,23,2,12,25,22,11,1,83,24,74,95,84,93,94,85,45,32 ...
    33,34,44,43,91,81,92,82,35,73,53,52,42,51,41,31,61,36,62,72,71];
...
% 1. fix cluster 26, which was 10% of the data classified as negative
% %%%%%%%%%%%%%%%%
fixCluster = 26;
...
for i=[1:29,31:points+1]
    ...
    save([path,'/Point',num2str(i),'/cellDataCategory171019.mat'],'dataPoint','Labels2Write');
...
save([pathCluster,'/dataSeparateImmuneTumor171019.mat'],'phenoS');