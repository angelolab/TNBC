...
phenoS = importdata([pathCluster,'/170831_exportTumorPhenoDataStd.csv']);
phenoCol = 70;
resultsDir = [path,'/dataPerCell170809/ClusterAll170831/'];


% add flowSOM data
flowSOMpath = '/Users/lkeren/Box Sync/Leeat_Share/Data/MIBIData/CleanData/NoAgg/dataPerCell170809/ClusterAll170831/flowsomresultsTumor170831.csv';
...
% cluster
clusterInds = [3,11,13,23,27,28,33,37];
