% MibiTNBCMarkImmuneClusters170814
...
resultsDir = [path,'dataPerCell170809/ClusterImmune/'];

phenoS = importdata([pathCluster,'/170809_exportImmunePhenoDataStd.csv']);
% phenoCol = 80;
% tsne1Col = 74;
% tsne2Col = 75;
phenoCol = 88;
...
% cluster
clusterInds = [4,6:8,15,19,20,21,26,29,36];
